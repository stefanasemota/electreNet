...
public class MoyenLiaison implements java.io.Serializable {
    private ch.albertlegrand.business.catalogue.com.electreNet.literalTypes.TypeLiaison typeLiaison;
    ...
    public MoyenLiaison(
            ch.albertlegrand.business.catalogue.com.electreNet.literalTypes.TypeLiaison typeLiaison,
            String valeur) {
     ...
     * @return typeLiaison
     */
    public ch.albertlegrand.business.catalogue.com.electreNet.literalTypes.TypeLiaison getTypeLiaison() {
        return typeLiaison;
    }
     ...
     * @param typeLiaison
     */
    public void setTypeLiaison(ch.albertlegrand.business.catalogue.com.electreNet.literalTypes.TypeLiaison typeLiaison) {
        this.typeLiaison = typeLiaison;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://electre.com/ElectreNET/literalTypes", "MoyenLiaison"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("typeLiaison");
        elemField.setXmlName(new javax.xml.namespace.QName("http://electre.com/ElectreNET/literalTypes", "typeLiaison"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://electre.com/ElectreNET/literalTypes", "TypeLiaison"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("valeur");
        elemField.setXmlName(new javax.xml.namespace.QName("http://electre.com/ElectreNET/literalTypes", "Valeur"));
