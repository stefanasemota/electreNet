...
public class ElementsNewsLetterLH implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://electre.com/ElectreNET/", "ElementsNewsLetterLH"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "prixTTC"));
