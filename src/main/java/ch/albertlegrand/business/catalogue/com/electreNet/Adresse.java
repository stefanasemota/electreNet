...
public class Adresse implements java.io.Serializable {
    private TypeAdresse typAdresse;
    ...
    private ch.albertlegrand.business.catalogue.com.electreNet.MoyenLiaison[] moyenLiaison;

    public Adresse() {
    }

    public Adresse(
            ch.albertlegrand.business.catalogue.com.electreNet.TypeAdresse typAdresse,
            String intitule,
            String complement,
            String num2Rue,
            String typvoie,
            ...
            String etatprov,
            String pays,
            ch.albertlegrand.business.catalogue.com.electreNet.MoyenLiaison[] moyenLiaison) {
     ...
     * @return typAdresse
     */
    public ch.albertlegrand.business.catalogue.com.electreNet.TypeAdresse getTypAdresse() {
        return typAdresse;
    }
     ...
     * @param typAdresse
     */
    public void setTypAdresse(ch.albertlegrand.business.catalogue.com.electreNet.TypeAdresse typAdresse) {
        this.typAdresse = typAdresse;
    }
     ...
     * @return moyenLiaison
     */
    public ch.albertlegrand.business.catalogue.com.electreNet.MoyenLiaison[] getMoyenLiaison() {
        return moyenLiaison;
    }
     ...
     * @param moyenLiaison
     */
    public void setMoyenLiaison(ch.albertlegrand.business.catalogue.com.electreNet.MoyenLiaison[] moyenLiaison) {
        this.moyenLiaison = moyenLiaison;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://electre.com/ElectreNET/", "Adresse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("typAdresse");
        elemField.setXmlName(new javax.xml.namespace.QName("", "typAdresse"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://electre.com/ElectreNET/", "TypeAdresse"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "num2rue"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "typvoie"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "codepost"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "etatprov"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "moyenLiaison"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://electre.com/ElectreNET/", "MoyenLiaison"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
