...
public class AuteurInfo implements java.io.Serializable {
    ...
    private ch.albertlegrand.business.catalogue.com.electreNet.AuteurType auteurType;
    ...
    public AuteurInfo(
            String nom,
            String id,
            ch.albertlegrand.business.catalogue.com.electreNet.AuteurType auteurType,
            String[] typParti) {
        this.nom = nom;
        this.id = id;
     ...
     * @return auteurType
     */
    public ch.albertlegrand.business.catalogue.com.electreNet.AuteurType getAuteurType() {
        return auteurType;
    }
     ...
     * @param auteurType
     */
    public void setAuteurType(ch.albertlegrand.business.catalogue.com.electreNet.AuteurType auteurType) {
        this.auteurType = auteurType;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://electre.com/ElectreNET/", "AuteurInfo"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("", "auteurType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://electre.com/ElectreNET/", "AuteurType"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("typParti");
        elemField.setXmlName(new javax.xml.namespace.QName("", "typParti"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
